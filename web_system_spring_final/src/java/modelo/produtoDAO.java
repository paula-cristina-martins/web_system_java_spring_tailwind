    ...
    public String cadastrarProduto(produto prod) {
        try {
            ...
            try {
                ...
                String sql = "INSERT INTO produto (lote, nome, descricao, fornecedor, quantidade, valorCompra, valorVenda) VALUES ("
                        + "'" + prod.getLote() + "','"
                        + prod.getNome() + "','"
                        + prod.getDescricao() + "','"
                        + prod.getFornecedor() + "','"
        ...
        try {
            ...
            try {
                ...
                String sql = "UPDATE produto SET "
                        ...
                        + "valorCompra='" + prod.getValorCompra() + "', "
                        + "valorVenda='" + prod.getValorVenda() + "' "
        ...
        try {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    prod.setValorCompra(resultSet.getString("valorCompra"));
                    prod.setValorVenda(resultSet.getString("valorVenda"));
                    produtos.add(prod);
                }
            } catch (Exception e) {
                e.printStackTrace();

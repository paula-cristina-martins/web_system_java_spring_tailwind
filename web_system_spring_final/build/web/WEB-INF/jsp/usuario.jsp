...
<html lang="pt-br">
    ...
    <body class="bg-gray-100 font-sans">
        <nav>
            ...
            <div class="hidden md:block bg-gray-800 text-white p-4">
                <div class="flex items-center justify-between pl-10">
                    ...
                    <div class="flex items-center pr-10">
                        <a href="/web_system_spring_final/index" class="mx-4 rounded-3xl py-1 px-3 hover:bg-blue-100 hover:text-gray-800">Início</a>
            ...
            <div class="md:hidden bg-gray-800 text-white px-6 py-4">
                ...
                <div id="menu" class="hidden mt-4 ml-2 uppercase">
                    <a href="/web_system_spring_final/index" class="block py-2">- Início</a>
        ...
        <form method="post" action="formulario" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 lg:mx-32 mt-5">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-3">
                        ...
                        <input id="senha" name="senha" type="password" value="<%= (request.getParameter("senha") != null) ? request.getParameter("senha") : ""%>" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    </div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <textarea id="observacao" name="observacao" rows="5" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"><%= (request.getParameter("observacao") != null) ? request.getParameter("observacao") : ""%></textarea>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="space-x-1 md:space-x-5">
                    <button 
                        class="botao-cadastrar bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded" 
                        name="acao" 
                        type="submit" 
                        value="cadastrar" 
                        onclick="validarForm()"
                    ...
                    <button 
                        class="botao-consultar bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded" 
                        name="acao" 
                        type="submit" 
                        value="consultar">
                        Consultar
                    ...
                    <button 
                        class="botao-alterar bg-yellow-700 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded" 
                        name="acao" 
                        type="submit" 
                        value="alterar">
                        Alterar
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 lg:mx-32 my-9">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="py-2 px-4 block md:flex justify-center md:space-x-2">
                            <form method="post" action="formulario">
                                ...
                                <button class="bg-blue-500 hover:bg-blue-400 text-white py-1 px-5 rounded-md" name="acao" type="submit" value="consultar_usuario" onclick="validarForm()">
                                    Editar
                                </button>
                            </form>                           
                            <form method="post" action="formulario">
                                <input type="hidden" name="cpf" value="<%= user.getCpf()%>">
                                <button class="bg-red-500 hover:bg-red-400 text-white py-1 px-4 mt-3 md:mt-0 rounded-md" name="acao" type="submit" value="excluir" onclick="validarForm()">
                                    Excluir
                                </button>
                            </form>                           
                        </td>

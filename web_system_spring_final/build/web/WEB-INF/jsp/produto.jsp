        ...
        <form method="post" action="formulario" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 lg:mx-32 mt-5">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="valorCompra">
                            Valor da Compra *
                        </label>
                        <input 
                            id="valorCompra" name="valorCompra" type="number" 
                            value="<%= (request.getParameter("valorCompra") != null) ? request.getParameter("valorCompra") : ""%>" 
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="valorVenda">
                            Valor da Venda *
                        </label>
                        <input 
                            id="valorVenda" name="valorVenda" type="number" 
                            value="<%= (request.getParameter("valorVenda") != null) ? request.getParameter("valorVenda") : ""%>" 
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    </div>
                </div>
                <div class="w-full">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="py-2 px-4 block md:flex justify-center md:space-x-2">
                            <form method="post" action="formulario">
                                ...
                                <input type="hidden" name="valorCompra" value="<%= prod.getValorCompra()%>">
                                <input type="hidden" name="valorVenda" value="<%= prod.getValorVenda()%>">
                                <button class="bg-blue-500 hover:bg-blue-400 text-white py-1 px-5 rounded-md" name="acao" type="submit" value="consultar_produto" onclick="validarForm()">
                                    Editar
                                </button>
                            </form>
                            <form method="post" action="formulario">
